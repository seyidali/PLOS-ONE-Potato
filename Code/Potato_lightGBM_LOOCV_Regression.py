# -*- coding: utf-8 -*-
"""
Created on Monday 3 March 2025
...
input_filename = 'Potato_Data.xlsx'
output_filename = 'output_lightGBM_Potato(TuberWeight).txt'
...
data_orj['Cultivar'] = data_orj['Cultivar'].astype('category')

data_pp = data_orj
print(data_pp)
    
# Tuberization% -- 6,    Tubers per plant  -- 7,    Tubers size -- 8 
# Tubers Weight -- 9
X = data_pp.iloc[:,[0, 1, 2, 3, 4, 5]].values
y = data_pp.iloc[:,[9]].values
